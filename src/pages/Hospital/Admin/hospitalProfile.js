                        ...
                        <Box p={{ xs: 2, sm: 6 }}>
                            <form autoComplete="off">
                                <TextField
                                    ...
                                    variant="standard"
                                    margin="normal"
                                    value={infoLoaded ? hospitalDetail.name : "Loading..."}
                                    type="text"
                                    required
                                ...
                                <TextField
                                    ...
                                    margin="normal"
                                    name="address"
                                    value={infoLoaded ? hospitalDetail.address : "Loading..."}
                                    required
                                    type="text"
                                    onChange={handleChange}
                                    InputLabelProps={{shrink: true,}}
                                ...
                                <TextField
                                    ...
                                    onChange={handleChange}
                                    margin="normal"
                                    value={infoLoaded ? hospitalDetail.telephone : "Loading..."}
                                    InputLabelProps={{shrink: true,}}
                                    required
                                />
                                <TextField
                                ...
                                {reqSuccessUpdate && <Alert onClose={handleAlertClose} severity="success">Hospital Details upadated</Alert>}
                            </form>
                        </Box>
                    </Grid>
                </Grid>
